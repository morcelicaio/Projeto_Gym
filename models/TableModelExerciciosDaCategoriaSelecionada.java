...
public class TableModelExerciciosDaCategoriaSelecionada extends AbstractTableModel{
    private String[] nomeColunas = {"Código", "Categoria", "Nome", "Descrição"};
    private ArrayList<Exercicio> exercicios;
    
    public TableModelExerciciosDaCategoriaSelecionada(){
        exercicios = new ArrayList<>();
    }
    
    public TableModelExerciciosDaCategoriaSelecionada(ArrayList<Exercicio> listaDeExercicios){
        this();
