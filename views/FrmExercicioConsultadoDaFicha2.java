...
public class FrmExercicioConsultadoDaFicha2 extends javax.swing.JFrame {
    private int recebeCodProf;
    
    public FrmExercicioConsultadoDaFicha2() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setAlwaysOnTop(true);
    }

    public FrmExercicioConsultadoDaFicha2(javax.swing.JFrame form, Exercicio e, int codProfessor){
        this();
    ...
    private void btnRetornarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetornarActionPerformed
        ...
        FrmConsultarFichaProfessor f = new FrmConsultarFichaProfessor(this, auxiliar, recebeCodProf);
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExercicioConsultadoDaFicha2().setVisible(true);
            }
        });
    }
