...
public class FrmExercicioConsultadoDaFicha extends javax.swing.JFrame {
    private int recebeMatriculaAluno;
    
    public FrmExercicioConsultadoDaFicha() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setAlwaysOnTop(true);
    }
    
    public FrmExercicioConsultadoDaFicha(javax.swing.JFrame form, Exercicio e, int matricula){
        this();

        this.recebeMatriculaAluno = matricula;
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(lbNomeExercicio, javax.swing.GroupLayout.DEFAULT_SIZE, 338, Short.MAX_VALUE)
                .addGap(22, 22, 22))
        );
        ...
        btnRetornar.setText("Retornar à ficha");
    ...
    private void btnRetornarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRetornarActionPerformed
        ...
        FrmConsultarFichaAluno f = new FrmConsultarFichaAluno(this, auxiliar, recebeMatriculaAluno);
        f.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExercicioConsultadoDaFicha().setVisible(true);
            }
        });
    }
